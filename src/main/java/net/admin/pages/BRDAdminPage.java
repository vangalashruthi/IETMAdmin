...
WebDriver driver;
	...
	@FindBy(how = How.XPATH ,using= "(//b[text()='Feb 21st 2022, 10:54 am'])[1]")
	WebElement startTimeInLastBackup;
	
	@FindBy(how = How.XPATH ,using= "(//b[text()='Feb 21st 2022, 10:54 am'])[2]")
	WebElement endTimeInLastBackup;
	
	@FindBy(how = How.XPATH ,using= "(//span[@class='text-success'])[1]")
	WebElement statusInLastBackup;
	
	@FindBy(how = How.XPATH ,using= "//b[text()='Jun 12th 2021, 05:29 pm']")
	WebElement startTimeInLastRestoration;
	
	@FindBy(how = How.XPATH ,using= "//b[text()='Jun 12th 2021, 05:32 pm']")
	WebElement endTimeInLastRestoration;
	
	@FindBy(how = How.XPATH ,using= "//b[text()='db_backup_120620211719.sql']")
